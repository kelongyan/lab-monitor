...
# 使用 Start-Process -WindowStyle Hidden 在后台独立启动 Python 进程
$process = Start-Process -FilePath "python" -ArgumentList "main.py" -WorkingDirectory $scriptDir -WindowStyle Hidden -PassThru
